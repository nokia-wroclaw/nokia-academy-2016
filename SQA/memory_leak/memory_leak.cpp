//przeprowadzić dynamiczną analizę wycieków pamięci przy pomocy valgrind'a
//przeprowadzić dynamiczną analizę wycieków pamięci używając lsan'a (przełącznik kompilatora)
